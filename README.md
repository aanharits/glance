...
<div align="center">
  <video src="https://github.com/user-attachments/assets/4e149ceb-9cfd-4a60-8e3c-54c800329e82" controls width="100%"></video>
</div>
...
```
 ...
 ┌───────────────────────────────────────────────────────────┐
 │                    Cloud AI Providers                     │
 │  • Groq (Qwen 3.8 27B Text Analysis)                       │
...
| **AI Inference**      | **Groq API** (Qwen 3.8 27B) for ultra-fast text, **Google Gemini 1.5** for vision.               |
